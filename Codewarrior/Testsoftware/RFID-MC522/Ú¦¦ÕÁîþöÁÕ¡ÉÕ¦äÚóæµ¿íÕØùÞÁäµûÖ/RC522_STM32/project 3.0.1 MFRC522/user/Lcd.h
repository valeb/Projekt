...
#define LCD_LightIsOn() ((GPIOC->IDR & 0X0040)?1:0 )//GPIO_ReadOutputDataBit(GPIOC, GPIO_Pin_6)
#define LCD_Light_On() 		GPIOC->BSRR=0X40//GPIO_SetBits(GPIOC, GPIO_Pin_6)
#define LCD_Light_Off()	 	GPIOC->BRR=0X40//GPIO_ResetBits(GPIOC, GPIO_Pin_6)
#define LCD_ILI9320_On()	GPIOC->BSRR=0X80//GPIO_SetBits(GPIOC, GPIO_Pin_7)
#define LCD_ILI9320_Off()	GPIOC->BRR=0X80//GPIO_ResetBits(GPIOC, GPIO_Pin_7)
...
void DisplayString(u16 x,u16 y, u8 *ptr, u16 charColor, u16 bkColor);
